...
if (isset($_GET['action']) && $_GET['action'] == 'history') {
  ...
  <div class="bnt btn-group"><div class="btn btn-info" data-toggle="collapse" data-target="#batchItemDetail" aria-expanded="false" aria-controls="batchItemDetail">' . __('Options') . '</div>';
    ...
    // Tambahkan kelas untuk kotak aksi atas
    $datagrid->setActionsFormBegin('<div class="datagrid-action-bar top">');

    // Tambahkan kelas untuk kotak aksi bawah  
    $datagrid->setActionsFormEnd('</div><div class="datagrid-action-bar bottom">');

// Tutup div kotak aksi bawah
$datagrid_result .= '</div>';
